...
public final class DropBoxUtils {
   ...
   */
  public static FileMetadata uploadFile(File pathFile, String pathDropBox, WriteMode mode)
    ...
    try (InputStream in = new FileInputStream(pathFile)) {
      ...
      throw new MajorException(
          "Erreur lors de l'upload du fichier: " + pathFile + " dans le dossier: " + dropBoxPath,
          e);
    }
