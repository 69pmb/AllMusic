...
public class Constant {
  ...
  private static final String[] NOT_SEPARATORS = {
    "(", ")", MyConstant.DOT, ",", "#", "'", "!", "*", "?", "/"
  };
  ...
  public static final Pattern PATTERN_DECADE =
      Pattern.compile("((?i)decade)|(" + TWO_DIGITS + "'s)|(" + TWO_DIGITS + "s)");

  public static final Pattern PATTERN_ALBUM = Pattern.compile("((?i)album)");

  public static final Pattern PATTERN_SONG =
      Pattern.compile("((?i)single)|((?i)track)|((?i)tune)|((?i)song)");

  public static final Pattern PATTERN_ALL_TIME =
      Pattern.compile(
          "((?i)greatest)|((?i)epic)|((?i)all time)|((?i)ever)|((?i)ultimate)|((?i)before you)|((?i)changed)");

  public static final Pattern PATTERN_GENRE =
      Pattern.compile(
          "((?i)punk)|((?i)reggae)|((?i)motown)|((?i)soul)|((?i)indie)|((?i)electro)|((?i)hop)|((?i)folk)|((?i)\brock)|((?i)wave)|((?i)britpop)|((?i)psych)|((?i)pop)");

  public static final Pattern PATTERN_THEME =
      Pattern.compile("((?i)american)|((?i)british)|((?i)reader)|((?i)guitar)|((?i)love)");
