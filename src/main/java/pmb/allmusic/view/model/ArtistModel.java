  ...
  public Class<?> getColumnClass(int col) {
    if (col == ArtistPanel.getIndex().get(Index.ARTIST)) {
      return String.class;
            ...
            ArtistPanel.getIndex().get(Index.SCORE_TOTAL),
            ArtistPanel.getIndex().get(Index.SCORE_SONG),
            ArtistPanel.getIndex().get(Index.SCORE_ALBUM),
            ArtistPanel.getIndex().get(Index.SCORE_DELETED),
            ArtistPanel.getIndex().get(Index.PERCENT_DELETED))
        .contains(col)) {
      return Long.class;
    } else {
