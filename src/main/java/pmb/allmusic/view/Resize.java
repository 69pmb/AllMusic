...
/**
 * Settings class to use with {@link ComponentBuilder}. Sets components width along with its panel
 * and label.
 */
public class Resize {
  ...
  /**
   * Constructs a {@link Resize} by telling the number of wanted components by given width.
   *
  ...
  /**
   * Constructs a {@link Resize} by telling the number of wanted components by screen width.
   *
   * @param count number of components
   */
