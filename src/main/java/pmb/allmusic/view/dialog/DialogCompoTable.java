...
public class DialogCompoTable extends AbstractFilterDialog<Composition> {
   ...
   */
  public DialogCompoTable(
      JDialog parent, String header, List<Composition> compo, String fileName, int height) {
    super(
        header,
        ...
        list ->
            CompositionUtils.convertCompositionListToVector(
                list, fileName, true, true, false, true, false),
  ...
  protected void initComposants() {
    ...
    try {
      setMyTable(
          new TableBuilder()
              .withModelAndData(null, header, CompoDialogModel.class)
                    ...
                    OngletPanel.getFichier()
                        .searchProgrammatically(
                            ...
                            VariousUtils.stringToUuids(
                                selectedRow.get(DialogCompoTable.getIndex().get(Index.UUID))));
                  },
                  true)
