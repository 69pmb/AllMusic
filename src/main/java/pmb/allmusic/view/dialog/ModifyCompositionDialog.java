  ...
  protected void initComposants() {
    ...
    JTextField artist =
        new ComponentBuilder<JTextField, String>(JTextField.class)
            .withParent(content)
            .withLabel("Artiste : ")
            .withInitialValue(compo.get(index.get(Index.ARTIST)))
            .withResize(resize)
            .build();
    ...
    JTextField titre =
        new ComponentBuilder<JTextField, String>(JTextField.class)
            .withParent(content)
            .withLabel("Titre : ")
            .withInitialValue(compo.get(index.get(Index.TITLE)))
            .withResize(resize)
            .build();
    ...
    JComboBox<RecordType> type =
        new ComponentBuilder<JComboBox, RecordType>(JComboBox.class)
            ...
            .withInitialValue(RecordType.valueOf(compo.get(index.get(Index.TYPE))))
            .withResize(resize)
            .build();
    ...
    JCheckBox deleted =
        new ComponentBuilder<JCheckBox, Boolean>(JCheckBox.class)
            ...
            .withLabel("Supprimé : ")
            .withResize(resize)
            .withInitialValue(Boolean.parseBoolean(compo.get(index.get(Index.DELETED))))
            .build();
