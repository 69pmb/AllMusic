...
public class DialogFilePopupMenu extends PopupMenu {
  ...
  public DialogFilePopupMenu(DialogFileTable dialogFileTable, ColumnIndex index) {
    ...
    buildCopySelectedRowFieldMenu(
        KeyEvent.VK_C, index.get(Index.FILE_NAME), "Copier le nom du fichier");
        ...
        (ActionEvent e) -> {
          ...
          OngletPanel.getFichier()
              .searchProgrammatically(
                  (String) selectedRow.get(index.get(Index.FILE_NAME)), Collections.emptyList());
