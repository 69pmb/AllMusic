...
/**
 * Enumération des différentes catégories de liste d'oeuvres musicales: bilan annuel, décennale, par
 * thème, par genre, sur une longue période de temps, "all time" ou divers.
 */
public enum Cat {
  YEAR("YEAR"),
  DECADE("DECADE"),
  ...
  public static Cat getByValue(String value) {
    return Arrays.stream(values())
        .filter(cat -> StringUtils.equalsAnyIgnoreCase(cat.toString(), value))
        .findFirst()
