...
public class AppTest {
	...
	public void testSearch() {
		...
		Fichier file1 = new Fichier("NME", "Best albums of the 60's", 2000, Cat.DECADE, 1960, 1969, false, 0,
				new Date(), 50);
		Fichier file2 = new Fichier("Pitchfork", "The best albums of The Beatles", 2010, Cat.MISCELLANEOUS, 1960, 1970,
				true, 2, new Date(), 10);
		files.add(file1);
		files.add(file2);
		...
		Fichier file3 = new Fichier("NME", "Best albums of the 90's", 2000, Cat.DECADE, 1990, 1999, true, 3,
				new Date(), 100);
