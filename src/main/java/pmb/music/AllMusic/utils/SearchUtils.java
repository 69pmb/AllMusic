...
public class SearchUtils {
    ...
    public static List<Composition> searchContains(List<Composition> compoList, Map<String, String> criteria) {
        List<Composition> arrayList = new ArrayList<Composition>(compoList);
        ...
        final boolean searchFile = StringUtils.isNotBlank(publish) || StringUtils.isNotBlank(fileName) || StringUtils.isNotBlank(auteur) || StringUtils.isNotBlank(cat)
                || StringUtils.isNotBlank(dateB) || StringUtils.isNotBlank(dateE);
        ...
        if (searchCompo || searchFile) {
            CollectionUtils.filter(arrayList, new Predicate() {
                ...
                public boolean evaluate(Object c) {
                    ...
                    List<Fichier> files = new ArrayList<Fichier>(co.getFiles());
                    if (searchFile) {
