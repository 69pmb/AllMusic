...
public class Fichier {
    ...
    public boolean equals(Object obj) {
        ...
        if (this.categorie != other.categorie) return false;
        if (this.classement != other.classement) return false;
        ...
        if (this.publishYear != other.publishYear) return false;
        if (this.rangeDateBegin != other.rangeDateBegin) return false;
        if (this.rangeDateEnd != other.rangeDateEnd) return false;
        if (this.size != other.size) return false;
        if (this.sorted == null) {
            if (other.sorted != null) return false;
        } else if (!this.sorted.equals(other.sorted)) return false;
        return true;
    }
}
